...
export default function ProjectCard({
  ...
  return (
    <div className="h-full group transition-transform duration-300 ease-in-out hover:-translate-y-1">
      <section className="bg-gray-100 dark:bg-white/10 border border-black/5 dark:border-transparent 
        ...
        <div className="flex flex-1 flex-col p-4 md:p-6">
          ...
          <p className="mt-1 text-xs text-gray-500 dark:text-white/60 md:text-sm">{date}</p>
          
          <div className="flex-1 mt-3 md:mt-4">
            <h4 className="font-semibold text-gray-800 dark:text-white/90 text-sm">Key Contributions:</h4>
